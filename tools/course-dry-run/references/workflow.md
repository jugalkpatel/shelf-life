...
- **Manifest source:** always derive the course workload from `../stevekinney.net/courses/self-testing-ai-agents/index.toml`. Never hard-code counts.
...
- **Course repository:** `/Users/stevekinney/Developer/stevekinney.net/courses/self-testing-ai-agents`
...
`summary.md` should always include the Codex refresh command:
